...
func CreateSearch_codeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_search_code",
		...
		mcp.WithString("sort", mcp.Description("Sorts the results of your query. Can only be `indexed`, which indicates how recently a file has been indexed by the GitHub search infrastructure. Default: [best match](https://docs.github.com/rest/reference/search#ranking-search-results)")),
