...
func CreateSearch_labelsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_search_labels",
		...
		mcp.WithString("q", mcp.Required(), mcp.Description("The search keywords. This endpoint does not accept qualifiers in the query. To learn more about the format of the query, see [Constructing a search query](https://docs.github.com/rest/reference/search#constructing-a-search-query).")),
		mcp.WithString("sort", mcp.Description("Sorts the results of your query by when the label was `created` or `updated`. Default: [best match](https://docs.github.com/rest/reference/search#ranking-search-results)")),
