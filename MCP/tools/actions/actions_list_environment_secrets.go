...
func Actions_list_environment_secretsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repositories/%s/environments/%s/secrets%s", cfg.BaseURL, repository_id, environment_name, queryString)
...
func CreateActions_list_environment_secretsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repositories_repository_id_environments_environment_name_secrets",
