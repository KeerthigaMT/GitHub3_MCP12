...
func Actions_add_selected_repo_to_required_workflowHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateActions_add_selected_repo_to_required_workflowTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_orgs_org_actions_required_workflows_required_workflow_id_repositories_repository_id",
		mcp.WithDescription("Add a repository to a required workflow"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_add_selected_repo_to_required_workflowHandler(cfg),
	}
}
