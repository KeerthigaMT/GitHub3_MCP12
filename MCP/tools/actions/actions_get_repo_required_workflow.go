...
func Actions_get_repo_required_workflowHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/actions/required_workflows/%s%s", cfg.BaseURL, org, repo, required_workflow_id_for_repo, queryString)
...
func CreateActions_get_repo_required_workflowTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_org_repo_actions_required_workflows_required_workflow_id_for_repo",
		mcp.WithDescription("Get a required workflow entity for a repository"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_get_repo_required_workflowHandler(cfg),
	}
}
