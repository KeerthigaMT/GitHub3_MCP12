...
func Actions_remove_selected_repo_from_required_workflowHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/actions/required_workflows/%s/repositories/%s%s", cfg.BaseURL, org, required_workflow_id, repository_id, queryString)
...
func CreateActions_remove_selected_repo_from_required_workflowTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_orgs_org_actions_required_workflows_required_workflow_id_repositories_repository_id",
		mcp.WithDescription("Remove a selected repository from required workflow"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_remove_selected_repo_from_required_workflowHandler(cfg),
	}
}
