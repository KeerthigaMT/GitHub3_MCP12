...
func Actions_list_required_workflowsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateActions_list_required_workflowsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_actions_required_workflows",
		mcp.WithDescription("List required workflows"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_list_required_workflowsHandler(cfg),
	}
}
