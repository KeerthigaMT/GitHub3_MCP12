...
func Actions_get_required_workflowHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateActions_get_required_workflowTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_actions_required_workflows_required_workflow_id",
		mcp.WithDescription("Get a required workflow"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_get_required_workflowHandler(cfg),
	}
}
