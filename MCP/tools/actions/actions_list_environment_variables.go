...
func CreateActions_list_environment_variablesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repositories_repository_id_environments_environment_name_variables",
		...
		mcp.WithNumber("per_page", mcp.Description("The number of results per page (max 30).")),
