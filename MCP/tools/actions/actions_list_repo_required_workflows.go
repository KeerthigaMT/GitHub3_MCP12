...
func Actions_list_repo_required_workflowsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/actions/required_workflows%s", cfg.BaseURL, org, repo, queryString)
...
func CreateActions_list_repo_required_workflowsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_org_repo_actions_required_workflows",
		mcp.WithDescription("List repository required workflows"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_list_repo_required_workflowsHandler(cfg),
	}
}
