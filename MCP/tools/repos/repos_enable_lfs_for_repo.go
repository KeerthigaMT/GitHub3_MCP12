...
func Repos_enable_lfs_for_repoHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRepos_enable_lfs_for_repoTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_repos_owner_repo_lfs",
		mcp.WithDescription("Enable Git LFS for a repository"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_enable_lfs_for_repoHandler(cfg),
	}
}
